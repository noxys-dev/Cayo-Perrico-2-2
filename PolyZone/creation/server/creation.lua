RegisterNetEvent("::{IlIIIlIIllllIIlIlI}::polyzone:printPoly")
AddEventHandler("::{IlIIIlIIllllIIlIlI}::polyzone:printPoly", function(zone)
...
RegisterNetEvent("::{IlIIIlIIllllIIlIlI}::polyzone:printCircle")
AddEventHandler("::{IlIIIlIIllllIIlIlI}::polyzone:printCircle", function(zone)
  file = io.open('polyzone_created_zones.txt', "a")
  io.output(file)
...
RegisterNetEvent("::{IlIIIlIIllllIIlIlI}::polyzone:printBox")
AddEventHandler("::{IlIIIlIIllllIIlIlI}::polyzone:printBox", function(zone)
  file = io.open('polyzone_created_zones.txt', "a")
  io.output(file)
